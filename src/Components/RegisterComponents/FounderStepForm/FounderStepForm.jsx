...
import './FounderStepForm.css'
import { useTranslation } from 'react-i18next';

const FounderStepForm = () => {
  ...
  let validationSchema = Yup.object({
    ...
    message: Yup.string().required('Please Enter description about Your Founder')
      .min(10, 'Minlength of Founder brief 20 chars')
      .max(200, 'Minlength of Founder brief 200 chars')
  });
  ...
  const handleVerificationSubmit = () => {
    ...
    setTimeout(() => {
      let close = document.querySelector('.close-2')
        close.click()
        navigate('/login');
    }, 5000);
  };
        ...
        <div className="modal-dialog modal-dialog-centered">
          ...
          <div className="modal-content p-5">
            <div className="modal-header text-center p-0">
              ...
              <button type="button" className="btn-close close-2 d-none" data-bs-dismiss="modal" aria-label="Close"></button>
...
export default FounderStepForm