...
import {
  ass5EvaluationTable,
  ass5QuestionsPartOne,
  ass5QuestionsPartOneTitles,
  ass5QuestionsPartTwo,
  ass5QuestionsPartTwoTitles,
  ass5StudentPerspectives,
} from "../../../../data";
...
const Assessment5Details = () => {
  ...
  return (
    <div className="ass5-details">
      ...
      <p className="special-p med-mb">{t("ass5p3")}</p>

      <p className="special-p">{t("ass5p4")}</p>
      ...
      <p className="special-p">{t("ass5p5")}</p>

      <p className="special-p">{t("ass5p6")}</p>

      <p className="special-p">{t("ass5p7")}</p>
      ...
      <div className=" m-5">
        <AssessmentTable
          Questions={ass5QuestionsPartOne}
          columnHead={ass5QuestionsPartOneTitles}
          btnName="Calculate"
        />
      </div>
      <p className="special-p mt-4 med-mb overflow-x-hidden">
        ...
        <a className=" text-dark text-decoration-underline" href="">
          {" "}
          http://www.metproject.org/downloads/Preliminary_FindingsResearch_Paper.pdf
        </a>
      </p>
