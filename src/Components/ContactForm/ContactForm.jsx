          ...
          <div className= {`col-lg-8 col-md-10 mx-auto px-md-0 px-4 step step-1 ${isRTL}`}>
            ...
            <div className="form-floating mb-4 mobile">
              <PhoneInput
                defaultCountry="SA"
                className={`form-control ${
                  formik.values.mobile && "input-border-color"
                }`}
                id="floatingPhone"
                placeholder={`${t("phone")}`}
                name="mobile"
              ...
              <span className={formik.values.mobile && "icon-active"}>
                <MdPhone />
              </span>
            ...
            <div className="form-floating mb-4">
              <textarea
                className={`form-control ${
                  formik.values.message && "input-border-color"
                }`}
          ...
          <div className="modal-content p-5">
            <div className="modal-header text-center p-0">
              ...
              <h2 className="modal-title" id="exampleModalToggleLabel3">
                Your message was sent successfully,We will respond to you as
                soon as possible
              </h2>
