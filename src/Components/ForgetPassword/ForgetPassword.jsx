...
const ForgetPassword = () => {
  ...
  async function forgetPass(value) {
    ...
    try {
      let data = await axios.post("api/v2/password/reset/", value);
  ...
  let validCode = Yup.object({
    resetCode1: Yup.string()
      .required("Reset Code is Required")
      .matches(/\d{1}/, "Please Enter Valid code")
      .max(1),
    resetCode2: Yup.string()
      .required("Reset Code is Required")
      .matches(/\d{1}/, "Please Enter Valid code")
      .max(1),
    resetCode3: Yup.string()
      .required("Reset Code is Required")
      .matches(/\d{1}/, "Please Enter Valid code")
      .max(1),
    resetCode4: Yup.string()
      .required("Reset Code is Required")
      .matches(/\d{1}/, "Please Enter Valid code")
      .max(1),
  });
  ...
  let validationSchemaPass = Yup.object({
    ...
    confirmNewPassword: Yup.string()
      ...
      .oneOf(
        [Yup.ref("newPassword")],
        "Confirmation Password doesnot match with the new password"
      ),
  });
            ...
            <div className="modal-content">
              <div className="modal-header p-0">
                <h1 className="modal-title" id="exampleModalToggleLabel">
                  Please enter your email <br />A Verification code will be sent
                  to your email
                </h1>
              </div>
            ...
            <form onSubmit={formik1.handleSubmit}>
                ...
                {[1, 2, 3, 4].map((index) => (
                  <input
                    ...
                    className={`form-control code-input ${
                      formik1.values[`resetCode${index}`] &&
                      "input-border-color"
                    }`}
                    ...
                    onChange={(e) => {
                      ...
                      if (e.target.value && index < 4) {
                        ...
                        document
                          .getElementById(`floatingCode${index + 1}`)
                          .focus();
                      }
                    }}
              ...
              <div className="modal-footer p-0">
                <button
                  ...
                  disabled={
                    !(formik1.isValid && formik1.dirty && isCodeComplete())
                  }
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content pass-modal">
            <div className="modal-header p-0">
              <h1 className="modal-title" id="exampleModalToggleLabel3">
            ...
            <form>
              <div className="form-floating my-4">
                <input
                  ...
                  className={`form-control ${
                    formik2.values.newPassword && "input-border-color"
                  }`}
                  id="floatingPassword"
                  name="newPassword"
                  placeholder=""
                ...
                <span
                  className={`cursor-pointer ${
                    formik2.values.newPassword && "icon-active"
                  }`}
              ...
              <div className="form-floating my-4">
                <input
                  type={showPassword ? "text" : "password"}
                  className={`form-control ${
                    formik2.values.confirmNewPassword && "input-border-color"
                  }`}
                ...
                <span
                  className={`cursor-pointer ${
                    formik2.values.confirmNewPassword && "icon-active"
                  }`}
                  onClick={() => setShowPassword(!showPassword)}
                >
                  {showPassword ? <BiSolidShow /> : <BiHide />}
